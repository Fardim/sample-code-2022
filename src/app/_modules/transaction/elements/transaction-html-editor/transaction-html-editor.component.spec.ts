...
import { TransactionHtmlEditorComponent } from './transaction-html-editor.component';

describe('TransactionHtmlEditorComponent', () => {
  let component: TransactionHtmlEditorComponent;
  let fixture: ComponentFixture<TransactionHtmlEditorComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ TransactionHtmlEditorComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TransactionHtmlEditorComponent);
  ...
  it('afterBlur()', () => {
    const updateHdvs = spyOn(component.transService, 'updateHdvs');
    component.editorValueChange('<p>Test!</p>');
    expect(updateHdvs).toHaveBeenCalled();
  });
});
