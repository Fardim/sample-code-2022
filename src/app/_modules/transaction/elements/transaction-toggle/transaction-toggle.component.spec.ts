...
import { TransactionToggleComponent } from './transaction-toggle.component';

describe('TransactionToggleComponent', () => {
  let component: TransactionToggleComponent;
  let fixture: ComponentFixture<TransactionToggleComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ TransactionToggleComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TransactionToggleComponent);
