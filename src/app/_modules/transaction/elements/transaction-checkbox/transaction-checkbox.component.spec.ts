...
import { TransactionCheckboxComponent } from './transaction-checkbox.component';

describe('TransactionCheckboxComponent', () => {
  let component: TransactionCheckboxComponent;
  let fixture: ComponentFixture<TransactionCheckboxComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ TransactionCheckboxComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TransactionCheckboxComponent);
