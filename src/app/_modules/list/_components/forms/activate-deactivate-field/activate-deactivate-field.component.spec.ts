...
import { ActivateDeactivateFieldComponent } from './activate-deactivate-field.component';

describe('ActivateDeactivateFieldComponent', () => {
  let component: ActivateDeactivateFieldComponent;
  let fixture: ComponentFixture<ActivateDeactivateFieldComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ ActivateDeactivateFieldComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(ActivateDeactivateFieldComponent);
