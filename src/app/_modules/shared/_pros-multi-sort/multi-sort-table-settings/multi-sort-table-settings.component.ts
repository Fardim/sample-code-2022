...
@Component({
  selector: 'pros-multi-sort-table-settings',
  templateUrl: './multi-sort-table-settings.component.html',
  styleUrls: ['./multi-sort-table-settings.component.scss']
})
export class MultiSortTableSettingsComponent implements OnInit {
