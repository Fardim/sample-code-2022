...
import { TransactionUrlComponent } from './transaction-url.component';

describe('TransactionUrlComponent', () => {
  let component: TransactionUrlComponent;
  let fixture: ComponentFixture<TransactionUrlComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ TransactionUrlComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TransactionUrlComponent);
