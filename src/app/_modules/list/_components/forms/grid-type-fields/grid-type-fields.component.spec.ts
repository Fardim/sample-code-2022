...
import { GridTypeFieldsComponent } from './grid-type-fields.component';

describe('GridTypeFieldsComponent', () => {
  let component: GridTypeFieldsComponent;
  let fixture: ComponentFixture<GridTypeFieldsComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [GridTypeFieldsComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(GridTypeFieldsComponent);
