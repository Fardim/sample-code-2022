...
describe('FormDateTimeComponent', () => {
  ...
  it('ngOnChanges()', async()=>{
    const changes = {
        selectedDate:{
            ...
            previousValue: {value:{start: new Date('9 Aug, 2021'),end: new Date('16 Aug, 2021')},type:'Last_2_Week'},
            firstChange: false,
    ...
    const changes1 = {
        selectedDate:{
            currentValue: {value:{start: new Date('9 Aug, 2021'),end: new Date('9 Aug, 2021')},type:'Last_2_Week'},
  ...
  it('updateDatePickerType(),updates date picker type', async()=>{
    ...
    // component.dateCtrl.addControl(component.formFieldId, new FormControl());
  ...
  it('isDateShown()', async()=>{
    component.selectedDateOption = 'Last_Week';
    component.currentPickerType = 'Week';
    component.selectedDate = null;
    expect(component.isDateShown()).toEqual(true);
  });
