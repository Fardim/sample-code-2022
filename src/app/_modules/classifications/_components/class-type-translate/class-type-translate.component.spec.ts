...
import { ClassTypeTranslateComponent } from './class-type-translate.component';

describe('ClassTypeTranslateComponent', () => {
    let component: ClassTypeTranslateComponent;
    let fixture: ComponentFixture<ClassTypeTranslateComponent>;
    let coreService: CoreService;
    let ruleService: RuleService;

    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [ClassTypeTranslateComponent],
    ...
    beforeEach(() => {
        fixture = TestBed.createComponent(ClassTypeTranslateComponent);
