...
import { AggregationOperator, AssginedColor, ChartProperties, ChartType, DisplayCriteria, FilterWidget, LegendPosition, SeriesWith, TimeseriesStartDate, Widget, WidgetAdditionalProperty, WidgetColorPalette, WidgetType, WidgetView, WidgetViewDetails, WidgetViewPayload, WidgetViewRequestPayload } from '@modules/report-v2/_models/widget';
...
import { TimseriesWidgetV2Component } from './timseries-widget-v2.component';

describe('TimseriesWidgetV2Component', () => {
  let component: TimseriesWidgetV2Component;
  let fixture: ComponentFixture<TimseriesWidgetV2Component>;
  ...
  beforeEach(async(() => {
    ...
    TestBed.configureTestingModule({
      declarations: [TimseriesWidgetV2Component],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TimseriesWidgetV2Component);
  ...
  //   expect(component.dataSetlabel.length).toEqual(2);
  ...
  it('updateForm(), update form element ', async(() => {
    ...
    component.widgetInfo.chartProperties.seriesWith = null;
    component.updateForm('MATL_TYPE', { id: 1, value: '7', isActive: false });
    expect(component.updateForm('MATL_TYPE', { id: 1, value: '7', isActive: false })).toBe(undefined);
  }));
  ...
  it('dateAndCountFormat()', async(() => {
    ...
    component.widgetInfo.chartProperties.seriesWith = SeriesWith.year;
    component.activeDateFormat = SeriesWith.year;
    component.dateAndCountFormat(dataObj, obj, dataArr);

    expect(obj.Year).toEqual('2019' + '\t');

    component.widgetInfo.chartProperties.seriesWith = SeriesWith.day;
    component.activeDateFormat = SeriesWith.day;
    ...
    component.widgetInfo.chartProperties.seriesWith = SeriesWith.month;
    component.activeDateFormat = SeriesWith.month;
    dataObj = { x: '1-10-2005', y: 2 };
    component.dateAndCountFormat(dataObj, obj, dataArr);

    expect(obj.Month).toEqual('Jan 2019' + '\t');

    component.widgetInfo.chartProperties.seriesWith = SeriesWith.quarter;
    component.activeDateFormat = SeriesWith.quarter;
    dataObj = { x: '1-10-2005', y: 2 };
    component.dateAndCountFormat(dataObj, obj, dataArr);

    expect(obj.Quarter).toEqual('Jan-Mar 2019' + '\t');

    component.widgetInfo.chartProperties.seriesWith = SeriesWith.week;
    component.activeDateFormat = SeriesWith.week;
    dataObj = { x: '1-10-2005', y: 2 };
    component.dateAndCountFormat(dataObj, obj, dataArr);

    expect(obj.Week).toEqual('05-Jan-19');
  ...
  it('getTableData(), should return table data', async () => {
    ...
    component.filterCriteria = [] as Criteria[];
    component.activeDateFormat = 'hour';
  ...
  it('getwidgetData() 1', async(() => {
    ...
    spyOn(service, 'getWidgetData').withArgs('653267432', component.filterCriteria, '', '', component.userDetails.selfServiceUserModel.timeZone, component.userDetails.defLocs.toString(), component.selectedPeriodOption).and.returnValue(of(buckets));
    component.getwidgetData(653267432);
    expect(service.getWidgetData).toHaveBeenCalledWith('653267432', component.filterCriteria, '', '', component.userDetails.selfServiceUserModel.timeZone, component.userDetails.defLocs.toString(), component.selectedPeriodOption);
  }));
  ...
  //   baseChart.options = {scales: {x: {ticks: {}}}};
  //   component.chart = baseChart;
  ...
  it('getDataFormat()', async(() => {
    ...
    component.widgetInfo = {chartProperties: { seriesFormat: 'mmm d, yy' }  } as Widget;
    component.getDataFormat();
    expect(component.getDataFormat).toBeTruthy();
    expect(component.getDataFormat()).toEqual('MMM D, YY');
  }));

  it('changeSeriesFormat(), should change series format',async() => {
    component.widgetInfo = {chartProperties: { seriesWith: SeriesWith.week }  } as Widget;
    component.dataSet = [{ data : [{x: 1639679400000, y: 1},{x: 16396723000000, y: 5}]}]
    component.changeSeriesFormat();
    expect(component.changeSeriesFormat).toBeTruthy();

    component.widgetInfo = {chartProperties: { seriesWith: SeriesWith.month }  } as Widget;
    component.dataSet = [{ data : [{x: 1639679400000, y: 1},{x: 16396723000000, y: 5}]}]
    component.changeSeriesFormat();
    expect(component.changeSeriesFormat).toBeTruthy();

    component.widgetInfo = {chartProperties: { seriesWith: SeriesWith.quarter }  } as Widget;
    component.dataSet = [{ data : [{x: 1639679400000, y: 1},{x: 16396723000000, y: 5}]}]
    component.changeSeriesFormat();
    expect(component.changeSeriesFormat).toBeTruthy();

    component.widgetInfo = {chartProperties: { seriesWith: SeriesWith.year }  } as Widget;
    component.dataSet = [{ data : [{x: 1639679400000, y: 1},{x: 16396723000000, y: 5}]}]
    component.changeSeriesFormat();
    expect(component.changeSeriesFormat).toBeTruthy();
  });
  ...
  it('changeScaleTicks(), method to change scales label for image download', async() => {
    ...
    baseChart.data = {labels: ['Label 1','Total'], datasets: []}
