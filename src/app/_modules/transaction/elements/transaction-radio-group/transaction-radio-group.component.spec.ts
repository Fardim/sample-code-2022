...
import { TransactionRadioGroupComponent } from './transaction-radio-group.component';

describe('TransactionRadioGroupComponent', () => {
  let component: TransactionRadioGroupComponent;
  let fixture: ComponentFixture<TransactionRadioGroupComponent>;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ TransactionRadioGroupComponent ],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TransactionRadioGroupComponent);
  ...
  it('afterBlur()', () => {
    ...
    const controlSpyObj = spyOn(component.control, 'setValue');
    component.valueChange(true);
    expect(controlSpyObj).toHaveBeenCalledWith(true);
